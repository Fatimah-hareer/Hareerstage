      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="blog-content">
            ...
            <div class="content">
                <h3 class="title">
                    @if(Session::get('language')==2) {{$blog->getTranslation('title','ar')}} @else {{$blog->getTranslation('details','en')}} @endif
                  </h3>
                  <ul class="post-meta">
                    <li>
                      <a href="javascript:;">
                  ...
                  <div id="overflowTest">@if(Session::get('language')==2) {{$blog->getTranslation('details','ar')}} @else {{$blog->getTranslation('details','en')}} @endif</div>
