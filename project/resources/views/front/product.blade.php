    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="pages">
          ...
          <li><a href="{{ route('front.product', $productt->slug) }}">@if(Session::get('language')==2) {{$productt->getTranslation('name','ar')}} @else {{$productt->getTranslation('name','en')}} @endif   </a>
            ...
            <div class="col-lg-7">
              <div class="right-area">
                <div class="product-info">
                  <h4 class="product-name">@if(Session::get('language')==2) {{$productt->getTranslation('name','ar')}} @else {{$productt->getTranslation('name','en')}} @endif</h4>
                      ...
                      <li class="d-block count {{ $productt->type == 'Physical' ? '' : 'd-none' }}">
                       ...
                       <div class="qty">
                          <ul>
                            ...
                            <li>
                              <span class="qttotal">@if($productt->min_order_qty) {{$productt->min_order_qty + 1}} @else 1 @endif  </span>
                            </li>
                            <li>
                              <span class="qtplus">
                  ...
                  <div id="product-details-tab">
                    ...
                    <div class="tab-content-wrapper">
                      <div id="tabs-1" class="tab-content-area">
                        <p> @if(Session::get('language')==2) {{$productt->getTranslation('details','ar')}} @else {{$productt->getTranslation('details','en')}} @endif </p>
                      </div>
...
$('.qtminus').click(function(){
  ...
  if(min_order+1 >= qty)
  {
    $(".qtminus").css("pointer-events", "none");
...
$('.qtplus').click(function(){
  ...
  if(min_order<qty+1)
  {
    $(".qtminus").css("pointer-events", "auto");
  }
     @endif
 //  alert(qty);
})
