            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-section-title" >
                        @if(Session::get('language')==2) {{$ps->contact_title_ar}} @else {{$ps->contact_title}} @endif
                    </br>
                            @if(Session::get('language')==2) {{$ps->contact_text_ar}} @else {{$ps->contact_text}} @endif
                    </div>
                </div>
            </div>
                        ...
                        <div class="contact-info">
                                ...
                                <div class="content d-flex align-self-center">
                                    <div class="content">
                                            <p>
                                                @if($ps->street != null)
                                                    @if(Session::get('language')==2) {{$ps->getTranslation('street','ar')}} @else {{$ps->getTranslation('street','en')}} @endif
