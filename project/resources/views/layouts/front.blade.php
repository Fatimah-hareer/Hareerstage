				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					<nav hidden>
						...
						<ul class="menu">
							...
							@endif
                                @php
                                   $pages= App\Models\Page::where('header','=',1)->get();
                                @endphp
{{--                                @foreach( $pages as $data)--}}
{{--                            --}}
{{--								<li><a href="{{ route('front.page',$data->title) }}">{{ $data->title }}</a></li>--}}
{{--							@endforeach--}}
							@if($gs->is_contact == 1)
				...
				<div class="col-md-6 col-lg-4">
					...
					<div class="fotter-social-links">
						<ul>
                                      ...
                                      <li>
                                        <a href="{{ $socialsetting->instagram }}" class="dribbble" target="_blank">
