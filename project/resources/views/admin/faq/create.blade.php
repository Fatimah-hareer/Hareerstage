                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-faq-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="nic-edit" name="details_en" placeholder="{{ __('Description') }}">{{ Request::old('details') }}</textarea>
                          </div>
                        </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <textarea  class="nic-edit" name="details_ar" placeholder="{{ __('Description') }}">{{ Request::old('details') }}</textarea>
                              </div>
                          </div>
