                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-cat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_en" placeholder="{{ __('Enter Name') }}" required="" value="{{$data->getTranslation('name','en')}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="name_ar" placeholder="{{ __('Enter Name') }}" required="" value="{{$data->getTranslation('name','ar')}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="slug_en" placeholder="{{ __('Enter Slug') }}" required="" value="{{$data->getTranslation('slug','en')}}">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" name="slug_ar" placeholder="{{ __('Enter Slug') }}" required="" value="{{$data->getTranslation('slug','ar')}}">
