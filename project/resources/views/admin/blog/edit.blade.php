                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-blog-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_en" placeholder="Title" value="{{$data->getTranslation('title','en')}}">
                          </div>
                        </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" name="title_ar" placeholder="Title" value="{{$data->getTranslation('title','ar')}}">
                              </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea class="nic-edit-p" name="details_en" placeholder="{{ __('Details') }}">{{ $data->getTranslation('details','en') }}</textarea>
                          </div>
                        </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <textarea class="nic-edit-p" name="details_ar" placeholder="{{ __('Details') }}">{{ $data->getTranslation('details','ar')  }}</textarea>
                              </div>
                          </div>
