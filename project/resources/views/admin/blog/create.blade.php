                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-blog-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_en" placeholder="{{ __('Title') }}" required="" value="">
                          </div>
                        </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" name="title_ar" placeholder="{{ __('Title') }}" required="" value="">
                              </div>
                          </div>
