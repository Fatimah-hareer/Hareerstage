                      ...
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea class="nic-edit"  name="contact_title_en"> {{ $data->contact_title }} </textarea>
                                  </div>
                              </div>
                            </div>
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="tawk-area">
                                        <textarea class="nic-edit"  name="contact_title_ar"> {{ $data->contact_title }} </textarea>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea class="nic-edit"  name="contact_text_en"> {{ $data->contact_text }} </textarea>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="tawk-area">
                                        <textarea class="nic-edit"  name="contact_text_ar"> {{ $data->contact_text }} </textarea>
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="row justify-content-center">
                              <div class="col-lg-3">
                                <div class="left-area">
                                  <h4 class="heading">
                                      {{ __('Contact Form Success Text') }} *</h4>
                                    <p class="sub-heading">{{ __('(In Any Language)') }}</p>
                                </div>
                              </div>
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea name="contact_success_en"> {{ $data->contact_success }} </textarea>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="tawk-area">
                                        <textarea name="contact_success_ar"> {{ $data->contact_success }} </textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                          ...
                          <div class="row justify-content-center">
                              ...
                              <div class="col-lg-6">
                                  <div class="tawk-area">
                                    <textarea name="street_en" placeholder="Enter Street Address"> {{ $data->street }} </textarea>
                                  </div>
                              </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="tawk-area">
                                        <textarea name="street_ar" placeholder="Enter Street Address"> {{ $data->street }} </textarea>
                                    </div>
                                </div>
                            </div>
