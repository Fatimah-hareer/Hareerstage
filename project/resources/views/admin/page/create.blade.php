                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-page-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_en" placeholder="{{ __('Title') }}" required="" value="{{ Request::old('title') }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="slug_en" placeholder="{{ __('Slug') }}" required="" value="{{ Request::old('slug') }}">
                          </div>
                        </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-7">
                                  <input type="text" class="input-field" name="slug_ar" placeholder="{{ __('Slug') }}" required="" value="{{ Request::old('slug') }}">
                              </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="nic-edit-p" name="details_en" placeholder="{{ __('Description') }}">{{ Request::old('details') }}</textarea>
