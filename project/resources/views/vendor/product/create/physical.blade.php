							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="row" id="stckprod">
										...
										<div class="col-lg-12">
											<input name="min_order_qty" type="text" class="input-field"
												placeholder="{{ $langg->lang666 }}">
									...
									<div class="row">
										<div class="col-lg-12 text-center">
											<button class="addProductSubmit-btn" type="button" id="create_product" onclick="submitForm()">{{ $langg->lang690 }}</button>
										</div>
									</div>
...
<script type="text/javascript">
	...
	function submitForm() {
		...
		$('form#geniusform').submit();
		$('form#geniusform').trigger("reset");
