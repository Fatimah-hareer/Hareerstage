...
class Product extends Model
{
    ...
    use HasTranslations;
    protected $fillable = ['user_id','category_id','product_type','affiliate_link','sku','min_order_qty', 'subcategory_id', 'childcategory_id', 'attributes', 'name', 'photo', 'size','size_qty','size_price', 'color', 'details','price','previous_price','stock','policy','status', 'views','tags','featured','best','top','hot','latest','big','trending','sale','features','colors','product_condition','ship','meta_tag','meta_description','youtube','type','file','license','license_qty','link','platform','region','licence_type','measure','discount_date','is_discount','whole_sell_qty','whole_sell_discount','catalog_id','slug'];

    public $translatable = ['name','details','meta_tag','meta_description'];
    ...
    public function showName() {
        ...
        $name = mb_strlen( $this->getTranslation('name','ar'),'utf-8') > 55 ? mb_substr( $this->getTranslation('name','ar'),0,55,'utf-8').'...' :  $this->getTranslation('name','ar'); 
         else
         $name = mb_strlen($this->getTranslation('name','en'),'utf-8') > 55 ? mb_substr($this->getTranslation('name','en'),0,55,'utf-8').'...' : $this->getTranslation('name','en');
        return $name;
    }
