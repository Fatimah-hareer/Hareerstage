...
class PageSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
       ...
       $input['contact_title'] = $request->input('contact_title_en');

       $input['contact_title_ar'] = $request->input('contact_title_ar');

        $input['contact_text'] = $request->input('contact_text_en');

        $input['contact_text_ar'] = $request->input('contact_text_ar');

// [
//            'ar'=>$request->input('contact_title_ar'),
//            'en'=>$request->input('contact_title_en')
//        ];
//        $input['contact_text'] = [
//            'ar'=>$request->input('contact_text_ar'),
//            'en'=>$request->input('contact_text_en')
//        ];
        $input['street'] = [
            'ar'=>$request->input('street_ar'),
            'en'=>$request->input('street_en')
        ];

        $input['contact_success'] = [
            'ar'=>$request->input('contact_success_ar'),
            'en'=>$request->input('contact_success_en')
        ];
